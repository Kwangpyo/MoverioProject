...
public class FaceDetect extends Activity implements CameraBridgeViewBase.CvCameraViewListener2{
...
//                        showDialogForPermission("앱을 실행하려면 퍼미션을 허가하셔야합니다.");
    ...
    private void copyFile(String filename) {
        ...
        try {
            ...
            Log.d("copyfile", "copyFile :: 파일 복사 중 예외 발생 "+e.toString() );
        }
    ...
    private void read_cascade_file(){
        ...
        {
            Log.d("cacadeError","cascadeError");
        }
